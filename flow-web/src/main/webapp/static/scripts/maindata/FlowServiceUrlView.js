...
EUI.FlowServiceUrlView = EUI.extend(EUI.CustomUI, {
    ...
    initGrid : function(){
        ...
        return {
            ...
            gridCfg : {
           //     loadonce:true,
                	url : "http://localhost:8081/flow/maindata/flowServiceUrl/find",
                colModel : [{
            ...
            var infoBox = EUI.MessageBox({
                ...
                buttons :[{
                    ...
                    handler : function(){
                        ...
                        EUI.Store({
                            url : "http://localhost:8081/flow/maindata/flowServiceUrl/delete",
                            params : {
                                id:rowData.id
                            },
                            success : function(){
    ...
    saveFlowServiceUrl : function(data) {
        ...
        EUI.Store({
            url : "http://localhost:8081/flow/maindata/flowServiceUrl/update",
            params : data,
            success : function(){
                myMask.hide();
                EUI.getCmp("gridPanel").grid.trigger("reloadGrid");
