 ...
 * *************************************************************************************************
 */
public class DefaultBusinessModel2Condition extends com.ecmp.flow.entity.DefaultBusinessModel2 implements IConditionPojo {
    ...
    @ConditionAnnotaion(name="采购单价",rank = 3)
    public double getUnitPrice() {
        return super.getUnitPrice();
    }

    @ConditionAnnotaion(name="采购数量",rank = 4)
    public int getCount() {
