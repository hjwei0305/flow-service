...
//                    }
    ...
    private OperateResult taskRollBack(FlowHistory flowHistory, String opinion) {
        ...
        try {
            ...
            //初始化回退后的新任务
            initTask(flowHistory.getFlowInstance(), currTask.getTaskDefinitionKey(), flowHistory);
            return result;
        } catch (Exception e) {
            e.printStackTrace();
            e.printStackTrace();
...
//                    List<Executor> employees = iEmployeeService.getExecutorsByEmployeeIds(java.util.Arrays.asList(startUserId));
                    ...
                    nodeInfoListSons =  getCallActivityNodeInfo(flowTask,nodeInfo.getId(),nodeInfoListSons);
...
//                                        employees = iPositionService.getExecutorsByPosCateIds(idList);
                                        ...
                                        String url = Constants.BASIC_SERVICE_URL + Constants.BASIC_POSITION_GETEXECUTORSBYPOSCATEIDS_URL;
                                        employees = ApiClient.getEntityViaProxy(url,new GenericType<List<Executor>>() {},params);
...
//                    tempNodeInfo.setCurrentTaskType(flowTask.);
    ...
    private List<NodeInfo> getCallActivityNodeInfo(FlowTask flowTask,String currNodeId, List<NodeInfo> result){
        FlowInstance flowInstance = flowTask.getFlowInstance();
...
//            net.sf.json.JSONObject normal = defObj.getJSONObject("nodeConfig").getJSONObject("normal");
//            String callActivityDefKey = (String)normal.get("callActivityDefKey");
