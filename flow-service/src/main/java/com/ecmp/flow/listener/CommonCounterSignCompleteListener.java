...
//        processVariables.put("counterSign_agree", counterSignAgree);
//        processVariables.put("counterSign_opposition", counterSignOpposition);
//        processVariables.put("counterSign_waiver", counterSignWaiver);
//        //完成会签的次数
